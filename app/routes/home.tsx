    ...
    <div className="min-h-screen bg-[#040814] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#111827] via-[#040814] to-[#02040A] text-slate-200 font-sans selection:bg-teal-500/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-2xl tracking-tight text-white">GitStats<span className="text-teal-400">Embed</span></span>
            </div>
            <div className="flex items-center gap-6 text-sm font-medium">
              <a href="#" className="text-slate-400 hover:text-white transition-colors">Documentation</a>
              <a href="https://github.com" target="_blank" rel="noreferrer" className="bg-white/5 hover:bg-white/10 border border-white/10 text-white px-5 py-2.5 rounded-xl transition-all backdrop-blur-md shadow-lg shadow-black/20">
                Star on GitHub
              </a>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 relative">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-teal-500/20 blur-[120px] rounded-full pointer-events-none"></div>
          
          <h1 className="relative text-5xl sm:text-6xl font-extrabold tracking-tight mb-6 text-white">
          ...
          <p className="relative text-lg text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <form onSubmit={handleSearch} className="relative flex gap-3 max-w-lg mx-auto">
            <div className="relative flex-1 group">
              <span className="absolute inset-y-0 left-0 pl-4 pt-4 flex items-center pointer-events-none text-slate-500 font-mono text-sm group-focus-within:text-teal-400 transition-colors z-10">
                github.com/
              </span>
              <input 
                type="text" 
                ...
                placeholder="username"
                 className="w-full pl-[110px] pr-4 py-3.5 bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl shadow-inner focus:ring-2 focus:ring-teal-500/30 focus:border-teal-400 outline-none transition-all text-white placeholder-slate-600 font-medium"
              />
            </div>
            <button type="submit" className="bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-400 hover:to-teal-500 border border-teal-400/30 text-white px-8 py-3.5 rounded-2xl font-bold shadow-[0_0_20px_rgba(45,212,191,0.25)] hover:shadow-[0_0_25px_rgba(45,212,191,0.4)] transition-all flex items-center gap-2">
              Generate
            </button>
          </form>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {/* Theme Presets */}
            <div className="bg-white/[0.02] backdrop-blur-2xl p-7 rounded-3xl border border-white/[0.08] shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] relative overflow-hidden group">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="font-semibold text-lg text-white">Theme Presets</h3>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {Object.entries(THEMES).map(([key, theme]) => (
                  <button
                    ...
                    className={`py-2.5 px-3 rounded-2xl border text-sm font-semibold transition-all duration-300 ${
                      config.theme === key 
            ...
            <div className="bg-white/[0.02] backdrop-blur-2xl p-7 rounded-3xl border border-white/[0.08] shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] relative overflow-hidden group">
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <h3 className="font-semibold text-lg text-white">Customization</h3>
              </div>
              
              <div className="space-y-6">
                {/* Toggles */}
                <div className="flex items-center justify-between p-2 rounded-2xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
                  <label className="text-sm font-medium text-slate-300 cursor-pointer pl-1">Show Icons</label>
                  <button 
                ...
                <div className="flex items-center justify-between p-2 rounded-2xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
                  <label className="text-sm font-medium text-slate-300 cursor-pointer pl-1">Hide Border</label>
                  <button 
                ...
                <div className="pt-6 border-t border-white/[0.06] space-y-3">
                  <div className="flex items-center gap-3 mb-5 px-1">
                    ...
                    <span className="text-sm font-semibold text-slate-200">Colors</span>
                  </div>
                  ...
                  {[
                    ...
                    <div key={colorSetting.key} className="flex items-center justify-between p-2.5 rounded-2xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
                      <label className="text-sm text-slate-300">{colorSetting.label}</label>
                      <div className="flex items-center gap-3">
                        ...
                        <div className="relative w-8 h-8 rounded-xl overflow-hidden border border-white/20 shadow-lg cursor-pointer hover:scale-110 transition-transform">
                          <input 
                            type="color" 
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            {/* Live Preview */}
            <div className="bg-white/[0.02] backdrop-blur-2xl p-10 rounded-3xl border border-white/[0.08] shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] flex flex-col items-center justify-center min-h-[350px] relative overflow-hidden group">
              <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
              
              {/* Soft glow behind SVG */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-teal-500/10 rounded-full blur-[100px] pointer-events-none"></div>
              
              <div className="w-full max-w-[495px] relative z-10 transition-transform hover:scale-[1.02] duration-500">
                <SVGRenderer />
              </div>
            </div>
            ...
            <div className="bg-white/[0.02] backdrop-blur-2xl rounded-3xl border border-white/[0.08] shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] overflow-hidden relative group">
              ...
              <div className="border-b border-white/[0.08] px-8 py-5 bg-white/[0.01]">
              ...
              <div className="p-8 space-y-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between px-1">
                    <label className="text-sm font-semibold text-slate-300">Markdown</label>
                    <button 
                      onClick={() => copyToClipboard(markdownEmbed, 'md')}
                      className="text-xs flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white border border-white/5 hover:border-white/10 transition-all"
                    >
                      {copiedStates.md ? <Check className="w-3.5 h-3.5 text-teal-400" /> : <Copy className="w-3.5 h-3.5" />}
                      {copiedStates.md ? 'Copied!' : 'Copy code'}
                    </button>
                  </div>
                  <div className="relative group/code">
                    <pre className="p-5 bg-black/40 border border-white/[0.08] rounded-2xl text-sm font-mono text-slate-400 overflow-x-auto whitespace-pre-wrap break-all shadow-inner group-hover/code:border-white/15 transition-colors">
                      {markdownEmbed}
                    </pre>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between px-1">
                    <label className="text-sm font-semibold text-slate-300">HTML</label>
                    <button 
                      onClick={() => copyToClipboard(htmlEmbed, 'html')}
                      className="text-xs flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white border border-white/5 hover:border-white/10 transition-all"
                    >
                      {copiedStates.html ? <Check className="w-3.5 h-3.5 text-teal-400" /> : <Copy className="w-3.5 h-3.5" />}
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between px-1">
                    <label className="text-sm font-semibold text-slate-300">Direct URL</label>
                    <button 
                      onClick={() => copyToClipboard(embedUrl, 'url')}
                      className="text-xs flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white border border-white/5 hover:border-white/10 transition-all"
                    >
                      {copiedStates.url ? <Check className="w-3.5 h-3.5 text-teal-400" /> : <Copy className="w-3.5 h-3.5" />}
                      {copiedStates.url ? 'Copied!' : 'Copy URL'}
                    </button>
                  </div>
                  <div className="relative group/code">
                    <div className="p-4 bg-black/40 border border-white/[0.08] rounded-2xl flex items-center gap-4 overflow-hidden shadow-inner group-hover/code:border-white/15 transition-colors">
      ...
      <footer className="border-t border-white/[0.08] mt-24 py-10 bg-[#040814]/80 backdrop-blur-2xl">
